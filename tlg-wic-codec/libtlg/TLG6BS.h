...
public:
  TLG6BitStream(tTJSBinaryStream* outstream) : OutStream(outstream), BufferBitPos(0), BufferBytePos(0), BufferCapacity(0) {}
...
public:
  ...
  long GetBytePos() const {
    return BufferBytePos;
  }
  ...
  long GetBitLength() const {
    return BufferBytePos * 8 + BufferBitPos;
  }
